    ...
    return(<section id="privacy-section" className="section-secondary">
        <div className="container">
            ...
            <div className="row row-eq-height">
                <div className="col-md-12 row-wrap">
                    ...
                    <p className="item-text">
                        We collect information from you when you fill out a form, Use Live Chat or enter information on
                        our site.
                    </p>
                    ...
                    <p className="item-text">We collect your email address in order to:</p>
                    ...
                    <p className="item-text">
                        ...
                        <address>
                            <a href="https://www.narrafy.io">narrafy.io</a><br/>
                            Birch-Reichenwaldsgate 2F <br/>
                            Oslo, 0483 Norway <br/>
                            <a href="mailto:dronic@narrafy.io">Contact</a>
                        </address>
                    </p>
                </div>
            </div>
